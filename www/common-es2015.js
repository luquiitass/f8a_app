...
let FormEntryPage = class FormEntryPage extends src_app_models_modal_form__WEBPACK_IMPORTED_MODULE_2__["ModalForm"] {
    constructor(navParms, modalController, location, requestService, dialogService, authUser, util) {
        ...
        this.modelEntry = new src_app_api_models_model__WEBPACK_IMPORTED_MODULE_3__["Model"]('Entry', requestService);
    }
    initObject() {
        this.entry = {
    ...
    submit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            console.log('submit');
            this.modelEntry.api_create(this.entry).subscribe((respose) => {
                this.dialogService.dimissLoaging();
                if (respose['status'] == 'success') {
                    this.dimiss(respose['Entry']);
                }
            }, error => {
                this.dialogService.dimissLoaging();
            }, () => {
...
let FormExpensePage = class FormExpensePage extends src_app_models_modal_form__WEBPACK_IMPORTED_MODULE_2__["ModalForm"] {
    constructor(navParms, modalController, location, requestService, dialogService, authUser, util) {
        super(location, modalController);
        this.navParms = navParms;
        this.modalController = modalController;
        ...
        this.util = util;
        this.team_id = navParms.get('team_id');
        this.modelExpense = new src_app_api_models_model__WEBPACK_IMPORTED_MODULE_3__["Model"]('Expense', requestService);
    }
    initObject() {
        this.expense = {
            user_id: this.authUser.user.id,
    ...
    submit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.dialogService.loadingProgres();
            console.log('submit');
            this.modelExpense.api_create(this.expense).subscribe((respose) => {
                this.dialogService.dimissLoaging();
                if (respose['status'] == 'success') {
                    this.dimiss(respose['Expense']);
                }
            }, error => {
                this.dialogService.dimissLoaging();
            }, () => {
...
FormExpensePage.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavParams"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_5__["PlatformLocation"] },
    { type: src_app_api_request_service__WEBPACK_IMPORTED_MODULE_6__["RequestService"] },
...
let AddResultPage = class AddResultPage extends src_app_models_modal_form__WEBPACK_IMPORTED_MODULE_3__["ModalForm"] {
    constructor(navParms, modalController, location, requestService, dialogService, chatService) {
        super(location, modalController);
        this.navParms = navParms;
        this.modalController = modalController;
        this.requestService = requestService;
        ...
        this.numGoals = [];
        this.status = 'Jugado';
        this.serviceGame = new src_app_api_models_model__WEBPACK_IMPORTED_MODULE_6__["Model"]('Game', requestService);
        this.game = Object.assign({}, navParms.get('game'));
        for (var i = 0; i <= 30; i++) {
            this.numGoals.push(i);
        }
    ...
    confirm() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let msj = `Ten presente que al ${this.status} este partido ya no podrás modificar los datos, solo el administrador general podrá hacerlo.`;
            this.dialogService.presentAlertConfirm('Confirmar', msj, () => {
                this.submit();
            });
        });
    }
    submit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.dialogService.loadingProgres();
            console.log('submit');
            this.serviceGame.api_update(this.game).subscribe((respose) => {
                this.dialogService.dimissLoaging();
                if (respose['status'] == 'success') {
                    this.dimiss(this.game);
                }
            }, error => {
                this.dialogService.dimissLoaging();
            }, () => {
...
let UserFormPage = class UserFormPage extends src_app_models_modal_form__WEBPACK_IMPORTED_MODULE_7__["ModalForm"] {
    constructor(request, dialogService, viewCtrl, navParams, platform, utilDialog, location, chatService) {
        ...
        this.photoService.setElementImg('img_user', 700);
        this.id = navParams.get('id');
    }
    initObject() {
        this.user = {
...
let ListsHomeService = class ListsHomeService {
    constructor(utilArray) {
...
let SharerService = class SharerService {
    constructor(requestService, dialogService, iab, util) {
        this.requestService = requestService;
        this.dialogService = dialogService;
        this.iab = iab;
        this.util = util;
    ...
    shareGameFacebook(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const browser = this.iab.create(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].server_url_base + '/shareResult/' + id, '', {
                fullscreen: "yes"
            });
    ...
    updateVisibiliti() {
        if (!this.loadedAddThis)
            return;
        let element = document.getElementsByClassName('addthis-smartlayers');
        if (element) {
            if (window['addthis']) {
