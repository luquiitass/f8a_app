...
let BannerPageRoutingModule = class BannerPageRoutingModule {
};
...
let BannerPageModule = class BannerPageModule {
};
...
let BannerPage = class BannerPage {
    constructor(route, requestService, dialogService) {
        this.route = route;
    ...
    load(event = null) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.dialogService.loadingProgres('Cargando equipo');
            this.gameModel.api_functionModel(this.id, 'pageBanner').subscribe(response => {
                this.dialogService.dimissLoaging();
                if (response['status'] = 'success') {
                    this.game = response['data'];
                    setTimeout(this.createImage, 1000);
                }
            });
        });
    }
    createImage() {
        ...
        html2canvas__WEBPACK_IMPORTED_MODULE_6___default()(element).then((canvas) => {
            let MAX_WIDTH = 1000;
            if (MAX_WIDTH > element.offsetWidth)
                MAX_WIDTH = element.offsetWidth;
            const scaleSize = MAX_WIDTH / element.offsetWidth;
...
//# sourceMappingURL=pages-game-banner-banner-module-es2015.js.map