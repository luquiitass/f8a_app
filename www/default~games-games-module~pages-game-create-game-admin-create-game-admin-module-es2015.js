...
let CreateGameAdminPage = class CreateGameAdminPage {
    constructor(request, dialogService, viewCtrl, photoService, navParams, authUser, util, chatService, transfData) {
        var _a;
    ...
    submit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.serviceGame.api_function('createGameAdmin', this.game).subscribe(response => {
...
CreateGameAdminPage.ctorParameters = () => [
...
//# sourceMappingURL=default~games-games-module~pages-game-create-game-admin-create-game-admin-module-es2015.js.map