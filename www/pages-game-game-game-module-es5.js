(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-game-game-game-module"], {
    ...
    function srcAppPagesGameGameGamePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _add_result_add_result_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var src_app_services_lists_home_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var src_app_services_sharer_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/services/sharer.service */
      "./src/app/services/sharer.service.ts");

      var GamePage = /*#__PURE__*/function () {
        function GamePage(route, requesService, util, dialogService, modalController, router, navCtrl, listsHomeService, authUser, shareService) {
        ...
        _createClass(GamePage, [{
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 4:
                      this.gameModel.api_functionModel(this.id, 'dataProfile').subscribe(function (data) {
                        if (data['status'] == 'success') _this.game = data['data']; //console.log('Game',this.game);
                  ...
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (data) {
                        if (data.data['game']) {
                          _this2.game = _this2.game;

                          _this2.listsHomeService.remove('games', _this2.game.id);

                          _this2.router.navigateByUrl('results/profile/' + _this2.game.id);
                        }
                      });
                      _context2.next = 6;
          ...
          value: function isFinish() {
            var dateString = "".concat(this.game.date, " ").concat(this.game.time);
          ...
          value: function _delete() {
            ...
            this.gameModel.api_delete(this.game.id).subscribe(function (data) {
              ...
              if (data['status'] == 'success') {
                _this4.dialogService.showToast('Partido Eliminado', null, 'success'); //this.router.navigateByUrl('/home/games',{ replaceUrl: true });
                //window.location.assign('#/home/games')


                _this4.listsHomeService.remove('games', _this4.game.id);

                _this4.navCtrl.navigateRoot('/home/games'); //this.gameService.listDelete(game.id);
