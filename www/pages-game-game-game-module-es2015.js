...
let GamePage = class GamePage {
    constructor(route, requesService, util, dialogService, modalController, router, navCtrl, listsHomeService, authUser, shareService) {
        this.route = route;
    ...
    isFinish() {
        ...
        let dateEnable = moment__WEBPACK_IMPORTED_MODULE_9__(dateString).add(2, 'hours');
        let now = new Date();
