...
let PaymentTeamPage = class PaymentTeamPage extends src_app_models_modal_form__WEBPACK_IMPORTED_MODULE_6__["ModalForm"] {
    constructor(reqest, viewCtrl, modalController, dialogService, authUser, router, location, chatService) {
        ...
        this.segmentSelect = '1';
        this.errorName = '';
        this.errorAdmins = '';
        this.modelMercadoPago = new src_app_api_models_model__WEBPACK_IMPORTED_MODULE_2__["Model"]('MercadoPagoService', reqest);
        this.modelTeam = new src_app_api_models_model__WEBPACK_IMPORTED_MODULE_2__["Model"]('Team', reqest);
    ...
    preferenceApi() {
        ...
        this.modelMercadoPago.api_function('createPreference', {}).subscribe(response => {
    ...
    verifyNameSelect() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.dialogService.loadingProgres('verificando nombre');
            console.log('team', this.team);
            this.modelTeam.api_function('exist', this.team).subscribe(response => {
    ...
    saveTeam() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.dialogService.loadingProgres('Registrando');
            this.modelTeam.api_create(this.team).subscribe(response => {
                this.dialogService.dimissLoaging();
                if (response['status'] == 'success') {
...
PaymentTeamPage.ctorParameters = () => [
...
//# sourceMappingURL=default~pages-payment-team-payment-team-module~teams-teams-module-es2015.js.map