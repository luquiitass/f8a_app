  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-password-reset-password-reset-module"], {
    ...
    function srcAppPagesPasswordResetPasswordResetPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PasswordResetPage = /*#__PURE__*/function () {
        function PasswordResetPage(route, authUser, router) {
        ...
        _createClass(PasswordResetPage, [{
          ...
          value: function resetPassword() {
            ...
            this.error = '';
            this.process = true;
            this.authUser.resetPassword(this.data).subscribe(function (response) {
              console.log(response);

              if (response['status'] === 'success') {
                _this.router.navigateByUrl('/login');
              } else if (response['status'] == 'error') {
                _this.error = response['msjError'];
              }

              _this.process = false;
            }, function (error) {
              console.error(error);
              if (error['error'] && error['error']['errorValidaciones']) _this.error = error['error']['errorValidaciones'];

              if (_this.error == 'The given data failed to pass validation.') {
                _this.error = 'Los datos proporcionados no pasaron la validación.';
              }
      ...
      PasswordResetPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/password-reset/password-reset.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./password-reset.page.scss */
        "./src/app/pages/password-reset/password-reset.page.scss"))["default"]]
      })], PasswordResetPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-password-reset-password-reset-module-es5.js.map