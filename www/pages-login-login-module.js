        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.afAuth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_6__["default"].auth.GoogleAuthProvider())];
                    case 2:
                        res = _a.sent();
                        user = res.user;
                        data = {
                        ...
                        this.authUserService.loginSocial(data).finally(function () {
                            _this.loadingGoogle = false;
                            console.log('loadingGoogle', _this.loadingGoogle);
                        });
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
