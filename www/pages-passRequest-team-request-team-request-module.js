...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header>\n  <ion-toolbar>\n    <ion-title>Solicitud de pase</ion-title>\n    <ion-buttons slot=\"start\">\n      <ion-buttons slot=\"start\">\n        <ion-back-button defaultHref=\"/\"></ion-back-button>\n      </ion-buttons>    </ion-buttons>\n\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-card *ngIf=\"player && team\">\n    <ion-card-content>\n      <ion-text >\n        <h3 class=\"msj\">\n          ¿Deseas incluir a <b class=\"ion-text-dark\">{{player.name}}</b> a la plantilla de jugadores de <b>{{team.name}}</b>?\n        </h3>\n        <br>\n        <h3 class=\"msj\">\n          Una vez que <b>{{player.name}}</b> acepte la solicitud , podrás registrar los sucesos del mismo en los partido \n        </h3>\n      </ion-text>\n    </ion-card-content>\n  </ion-card>\n\n  <ion-button expand=\"block\" fill=\"outline\" (click)=\"send()\">Enviar</ion-button>\n\n</ion-content>\n");
...
var TeamRequestPageRoutingModule = /** @class */ (function () {
    function TeamRequestPageRoutingModule() {
    }
...
var TeamRequestPageModule = /** @class */ (function () {
    function TeamRequestPageModule() {
    }
...
var TeamRequestPage = /** @class */ (function () {
    ...
    TeamRequestPage.prototype.ngOnInit = function () {
        this.init();
    };
    TeamRequestPage.prototype.init = function (event) {
        var _this = this;
        if (event === void 0) { event = null; }
        this.passRequestModel.api_function('passTeamPage', { team_id: this.team_id, player_id: this.player_id }).subscribe(function (response) {
    ...
    TeamRequestPage.prototype.send = function () {
        var _this = this;
        this.sending = true;
        var parms = {
        ...
        this.passRequestModel.api_create(parms).subscribe(function (response) {
            if (response['status'] == 'success') {
                _this.utilDialog.showToast('Solicitud Enviada', null, 'info', 777);
    ...
    TeamRequestPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-passRequest-team-request-team-request-module.js.map