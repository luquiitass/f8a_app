...
var TeamsPage = /** @class */ (function () {
    ...
    TeamsPage.prototype.init = function (event) {
        var _this = this;
    ...
    TeamsPage.prototype.close = function () {
        this.auth.logout();
    };
    TeamsPage.prototype.newTeam = function () {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            if (data.data && data.data['team']) {
                                ...
                                _this.utilArray.listAddLast(_this.teams, team);
                            }
                        });
    ...
    TeamsPage.prototype.filterTeams = function (event) {
        ...
        this.teams = this.teams.filter(function (team) { return team.name.toUpperCase().includes(text.toUpperCase()); });
    };
    TeamsPage.prototype.cancelFilter = function ($event) {
        this.teams = this.oldTeams;
    };
    TeamsPage.ctorParameters = function () { return [
