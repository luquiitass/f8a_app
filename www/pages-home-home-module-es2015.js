...
const VAPID_KEY = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["InjectionToken"]('angularfire2.messaging.vapid-key');
const SERVICE_WORKER = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["InjectionToken"]('angularfire2.messaging.service-worker-registeration');
// SEMVER(7): drop
const firebaseLTv8 = parseInt(firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].SDK_VERSION, 10) < 8;
class AngularFireMessaging {
    constructor(options, nameOrConfig, 
    // tslint:disable-next-line:ban-types
    platformId, zone, vapidKey, _serviceWorker) {
        const schedulers = new _angular_fire__WEBPACK_IMPORTED_MODULE_5__["ɵAngularFireSchedulers"](zone);
        const serviceWorker = _serviceWorker;
        const messaging = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(undefined).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(() => Object(_angular_common__WEBPACK_IMPORTED_MODULE_6__["isPlatformServer"])(platformId) ? rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"] : __webpack_require__.e(/*! import() | firebase-messaging */ "firebase-messaging").then(__webpack_require__.bind(null, /*! firebase/messaging */ "./node_modules/firebase/messaging/dist/index.esm.js"))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(() => Object(_angular_fire__WEBPACK_IMPORTED_MODULE_5__["ɵfirebaseAppFactory"])(options, zone, nameOrConfig)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(app => Object(_angular_fire__WEBPACK_IMPORTED_MODULE_5__["ɵfetchInstance"])(`${app.name}.messaging`, 'AngularFireMessaging', app, () => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            return messaging;
        }), [vapidKey, serviceWorker])), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])({ bufferSize: 1, refCount: false }));
        this.requestPermission = messaging.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), 
        // tslint:disable-next-line
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(messaging => firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].messaging.isSupported() ? messaging.requestPermission() : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])('Not supported.')));
        this.getToken = messaging.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((messaging) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].messaging.isSupported() && Notification.permission === 'granted') {
                if (firebaseLTv8) {
        ...
        const notificationPermission$ = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](emitter => {
            navigator.permissions.query({ name: 'notifications' }).then(notificationPerm => {
                notificationPerm.onchange = () => emitter.next();
            });
        });
        const tokenChange$ = messaging.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMapTo"])(notificationPermission$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMapTo"])(this.getToken));
        this.tokenChanges = messaging.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(() => firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].messaging.isSupported() ? Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["concat"])(this.getToken, tokenChange$) : rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"]));
        this.messages = messaging.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(messaging => firebase_app__WEBPACK_IMPORTED_MODULE_2__["default"].messaging.isSupported() ? new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](emitter => messaging.onMessage(next => emitter.next(next), err => emitter.error(err), () => emitter.complete())) : rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"]));
        this.requestToken = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(undefined).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(() => this.requestPermission), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(() => this.tokenChanges));
        // SEMVER(7): drop token
        this.deleteToken = (token) => messaging.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["subscribeOn"])(schedulers.outsideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["observeOn"])(schedulers.insideAngular), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(messaging => messaging.deleteToken(token || undefined)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["defaultIfEmpty"])(false));
        return Object(_angular_fire__WEBPACK_IMPORTED_MODULE_5__["ɵlazySDKProxy"])(this, messaging, zone);
    }
}
AngularFireMessaging.ɵfac = function AngularFireMessaging_Factory(t) { return new (t || AngularFireMessaging)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire__WEBPACK_IMPORTED_MODULE_5__["FIREBASE_OPTIONS"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire__WEBPACK_IMPORTED_MODULE_5__["FIREBASE_APP_NAME"], 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](VAPID_KEY, 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](SERVICE_WORKER, 8)); };
/** @nocollapse */ AngularFireMessaging.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ factory: function AngularFireMessaging_Factory() { return new AngularFireMessaging(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire__WEBPACK_IMPORTED_MODULE_5__["FIREBASE_OPTIONS"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire__WEBPACK_IMPORTED_MODULE_5__["FIREBASE_APP_NAME"], 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](VAPID_KEY, 8), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](SERVICE_WORKER, 8)); }, token: AngularFireMessaging, providedIn: "any" });
/** @nocollapse */
AngularFireMessaging.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_fire__WEBPACK_IMPORTED_MODULE_5__["FIREBASE_OPTIONS"],] }] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_fire__WEBPACK_IMPORTED_MODULE_5__["FIREBASE_APP_NAME"],] }] },
    { type: Object, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"],] }] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] },
    { type: String, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [VAPID_KEY,] }] },
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [SERVICE_WORKER,] }] }
];
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AngularFireMessaging, [{
        ...
        args: [{
            ...
            }] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"] }, { type: String, decorators: [{
                type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"]
            }, {
                type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"],
                args: [VAPID_KEY]
...
Object(_angular_fire__WEBPACK_IMPORTED_MODULE_5__["ɵapplyMixins"])(AngularFireMessaging, [proxyPolyfillCompat]);

class AngularFireMessagingModule {
}
AngularFireMessagingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: AngularFireMessagingModule });
AngularFireMessagingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AngularFireMessagingModule_Factory(t) { return new (t || AngularFireMessagingModule)(); }, providers: [AngularFireMessaging] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AngularFireMessagingModule, [{
...
const routes = [
    {
        ...
        children: [
            {
                path: 'teams',
                loadChildren: () => Promise.all(/*! import() | teams-teams-module */[__webpack_require__.e("default~pages-payment-team-payment-team-module~teams-teams-module"), __webpack_require__.e("teams-teams-module")]).then(__webpack_require__.bind(null, /*! ./teams/teams.module */ "./src/app/pages/home/teams/teams.module.ts")).then(m => m.TeamsPageModule)
            },
            {
                path: 'results',
...
let HomePage = class HomePage {
    constructor(platform, splashScreen, statusBar, auth, alertController, _location, paymentTeamService, chatService, messagingService, toastCtrl, shareService) {
    ...
    initializeApp() {
        ...
        setInterval(() => {
            if (this.auth.user)
                this.auth.userModel.api_functionModel(this.auth.user.id, 'changesNotifications').subscribe(response => {
    ...
    requestPermission() {
        this.messagingService.requestPermission().subscribe((token) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            //throw new Error( `user:${this.auth.user.completeName} token:${token}`);
