(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["results-results-module"], {
    ...
    function srcAppPagesHomeResultsResultsPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_payment_team_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/services/payment-team.service */
      "./src/app/services/payment-team.service.ts");
      /* harmony import */


      var src_app_services_lists_home_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/services/lists-home.service */
      "./src/app/services/lists-home.service.ts");

      var ResultsPage = /*#__PURE__*/function () {
        function ResultsPage(request, util, dialogService, paymentTeamService, listsHomeService) {
          ...
          this.listsHomeService = listsHomeService; //public list : any = [];
                    ...
                    case 8:
                      this.modelGame.api_function('resultsByDate', {
                        ...
                        if (response['status'] == 'success') {
                          ...
                          _this2.listsHomeService.results = _this2.tabs[index]['results'];
