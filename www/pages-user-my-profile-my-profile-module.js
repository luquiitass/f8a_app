...
var MyProfilePage = /** @class */ (function () {
    function MyProfilePage(authUser, requestService, modalController, transferData, chatService) {
    ...
    MyProfilePage.prototype.init = function (event) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        modal = _a.sent();
                        modal.onDidDismiss().then(function (data) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
                            var item;
                            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        console.log(data);
                                        if (!(data.data && data.data['user'])) return [3 /*break*/, 2];
                                        item = data.data['user'];
                                        this.user.first_name = item.first_name;
                                        this.user.last_name = item.last_name;
                                        this.user.photo = item.photo;
                                        this.user.email = item.email;
                                        return [4 /*yield*/, this.authUser.setUser(this.user)];
                                    case 1:
                                        _a.sent();
                                        _a.label = 2;
...
//# sourceMappingURL=pages-user-my-profile-my-profile-module.js.map