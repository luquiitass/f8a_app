...
var ListPage = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            var typeEvent = data.data['typeEvent'];
                            _this.typeEventService.listAddLast(typeEvent);
                        });
    ...
    ListPage.prototype.showEdit = function (typeEvent) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            console.log(data);
                            var item = data.data['typeEvent'];
                            _this.typeEventService.listUpdate(typeEvent.id, item);
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
                }
    ...
    ListPage.prototype.confirmDelete = function (typeEvent) {
        var _this = this;
        this.dialog.presentAlertConfirm('Confirmar', 'Estas seguro de eliminar este typeEvent', function (e) {
            _this.delete(typeEvent);
        });
    };
    ListPage.prototype.delete = function (typeEvent) {
        var _this = this;
        this.typeEventService.api_delete(typeEvent.id).subscribe(function (data) {
            console.log(data);
            if (data['status'] == 'success') {
                _this.dialog.showToast('TypeEvent Eliminado', null, 'success');
                _this.typeEventService.listDelete(typeEvent.id);
            }
        });
    };
...
//# sourceMappingURL=pages-typeEvent-list-list-module.js.map