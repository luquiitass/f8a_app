...
let TeamGamesPageRoutingModule = class TeamGamesPageRoutingModule {
};
...
let TeamGamesPageModule = class TeamGamesPageModule {
};
...
let TeamGamesPage = class TeamGamesPage {
    ...
    init(event = null) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.modelTeam.api_functionModel(this.id, 'pageGames', parms).subscribe(response => {
...
//# sourceMappingURL=pages-team-team-games-team-games-module-es2015.js.map