...
var PasswordResetPageRoutingModule = /** @class */ (function () {
    function PasswordResetPageRoutingModule() {
    }
...
var PasswordResetPage = /** @class */ (function () {
    ...
    PasswordResetPage.prototype.resetPassword = function () {
        ...
        this.authUser.resetPassword(this.data).subscribe(function (response) {
            ...
            if (error['error'] && error['error']['errorValidaciones'])
                _this.error = error['error']['errorValidaciones'];
    ...
    PasswordResetPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-password-reset-password-reset-module.js.map