(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-game-result-result-module"], {
    ...
    function srcAppPagesGameResultResultPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_lists_home_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/services/lists-home.service */
      "./src/app/services/lists-home.service.ts");
      /* harmony import */


      var src_app_services_auth_user_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var ResultPage = /*#__PURE__*/function () {
        function ResultPage(route, requesService, dialogService, socialSharing, util, listsHomeService, navCtrl, authUser, shareService) {
          ...
          this.resultModel = new src_app_api_models_model__WEBPACK_IMPORTED_MODULE_3__["Model"]('Game', requesService); //throw new Error('error test')
        }
        ...
        _createClass(ResultPage, [{
          ...
          key: "sendInstagram",
          value: function sendInstagram() {
            this.socialSharing.shareViaInstagram('Imagen', 'https://api.futbol8alem.com/imagecache/original/8lNFig1mR35YTYU.png');
          }
        }, {
          key: "share",
          ...
          value: function _delete() {
            ...
            this.resultModel.api_delete(this.game.id).subscribe(function (data) {
              ...
              if (data['status'] == 'success') {
                _this3.dialogService.showToast('Partido Eliminado', null, 'success');

                _this3.listsHomeService.remove('results', _this3.game.id);

                _this3.navCtrl.navigateRoot('/home/results');
              }
            });
          }
        }, {
