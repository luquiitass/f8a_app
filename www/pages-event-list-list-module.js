...
var ListPage = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            ...
                            _this.eventService.listAddLast(event);
                        });
    ...
    ListPage.prototype.showEdit = function (event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss().then(function (data) {
                            console.log(data);
                            _this.eventService.listUpdate(event.id, event);
                        });
                        return [4 /*yield*/, modal.present()];
                    case 2: return [2 /*return*/, _a.sent()];
                }
    ...
    ListPage.prototype.confirmDelete = function (event) {
        var _this = this;
        this.dialog.presentAlertConfirm('Confirmar', 'Estas seguro de eliminar este event', function (e) {
            _this.delete(event);
        });
    };
    ListPage.prototype.delete = function (event) {
        var _this = this;
        this.eventService.api_delete(event.id).subscribe(function (data) {
            console.log(data);
            if (data['status'] == 'success') {
                _this.dialog.showToast('Evento Eliminado', null, 'success');
                _this.eventService.listDelete(event.id);
            }
        });
    };
...
//# sourceMappingURL=pages-event-list-list-module.js.map