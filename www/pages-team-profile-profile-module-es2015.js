...
let ProfilePage = class ProfilePage {
    constructor(route, requesService, modalController, navCtrl, authUser, utilArray, paymentTeam, shareService, dialogService) {
        this.route = route;
    ...
    init($events = null) {
        ...
        this.teamModel.api_functionModel(this.id, 'pageProfile').subscribe(response => {
            ...
            if (response['status'] == 'success') {
                ...
                this.paymentTeam.setTeam(this.team);
    ...
    adminPlayers() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this.paymentTeam.noPaid()) {
                yield this.paymentTeam.showAlert();
                return;
            }
    ...
    addField(field) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.dialogService.loadingProgres('Añadiendo Cancha');
            this.teamModel.api_functionModel(this.id, 'addField', { field_id: field.id }).subscribe(response => {
                if (response['status'] == 'success') {
                    if (response['data'] && response['data']) {
                        this.team.field = response['data'];
                    }
                }
    ...
    confirmDeleteField(field) {
        ...
        this.dialogService.presentAlertConfirm('Confirmar', 'Estas seguro de eliminar esta cancha', e => {
    ...
    deleteField(field) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.teamModel.api_functionModel(this.id, 'removeField', { field_id: field.id }).subscribe(data => {
                console.log(data);
                if (data['status'] == 'success') {
                    this.dialogService.showToast('Cancha Eliminada', null, 'success');
