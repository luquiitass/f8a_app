(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-player-list-list-module~pages-player-player-form-player-form-module~pages-player-profi~8fa66a7a"], {
    ...
    function srcAppPagesPlayerPlayerFormPlayerFormPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PlayerFormPage = /*#__PURE__*/function (_src_app_models_modal) {
        _inherits(PlayerFormPage, _src_app_models_modal);

        var _super = _createSuper(PlayerFormPage);
                    ...
                    case 5:
                      this.servicePlayer.api_find(this.id).subscribe(function (data) {
                        if (data['status'] == 'success') {
                          ...
                          if (_this2.player.photo) _this2.photoModel.setImage(_this2.player.photo);
                          _this2.canEditUser = _this2.player && !_this2.player.user_id;
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this6.router.navigateByUrl("team-request/".concat(_this6.team_id, "/").concat(user.player.id));
